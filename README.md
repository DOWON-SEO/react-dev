...
Typescript 기반의 React 프로젝트를 생성하여 직접 구성 요소들을 사용하고 익혀볼 수 있는 Repository

**주요 학습 내용**

-   JSX 구문
-   Tailwind CSS를 활용한 클래스 기반 CSS 프레임워크 학습
-   Context API와 Redux 기반의 상태 관리
-   라우팅을 이용해 CSR 개념 이해와 SPA 구현
-   백엔드 서버와의 REST API 통신
-   토큰 인증을 통한 사용자 검증
